...
const { processFields } = require(path.resolve('config', 'multer'));
...
routes.post('/sobreMim', auth, upload.fields([{ name: 'foto', maxCount: 1 }, { name: 'curriculo', maxCount: 1 }]), processFields, validateSobreMimUpsert, SobreMimController.upsert);
