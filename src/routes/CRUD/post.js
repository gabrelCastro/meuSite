...
routes.post("/post", auth, upload.single('imagem'), validatePostCreate, postController.postStore);
...
routes.put("/postEditar/:id", auth, upload.single("imagem"), validatePostUpdate, postController.putPost);
